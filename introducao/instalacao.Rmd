---
title: "Intalação do R"
subtitle: "Adaptação do tutorial oficial do learnR"
output: 
  learnr::tutorial:
  progressive: true
allow_skip: true
...
Este tutorial irá ajudá-lo a configurar seu computador para usar o R. Seus objetivos são:

* Instalar R no seu computador
* Instalar o RStudio IDE
* Instalar o pacote `tidyverse` R
* Aprender a executar o código R

Se você já fez tudo isso, pode saltar este tutorial.

### Verifique se este tutorial é para você.



```{r quiz1, echo = FALSE}
question("Assinale todas opções verdadeiras. U não:",
  answer("instalei o R no meu computador", message = "* Install R"),
  answer("instalei o IDE do RStudio", message = "* Instale o IDE do RStudio"),
  answer("instalei o pacote tidyverse", message = "* Intall packages"),
  answer("usei R antes", message = "* Run Code"),
  answer("Nenhuma das opções acima. Já fiz tudo.", correct = TRUE, message = "Pode saltar esse tutorial!"),
  type = "multiple",
  incorrect = "Este tutorial é para ajudar! Para iniciar leia:"
)
```
